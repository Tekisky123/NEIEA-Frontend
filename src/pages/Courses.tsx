      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          {role === "institution" && selectedCourses.length > 0 && (
            <div className="mb-4 flex flex-col sm:flex-row sm:items-center justify-between bg-blue-50 border-l-4 border-blue-400 p-3 text-sm text-blue-700">
              <div className="mb-2 sm:mb-0">
                <strong>{selectedCourses.length}</strong> course(s) selected
              </div>
              <Button
                onClick={handleSubmit}
                className="bg-ngo-color6 hover:bg-ngo-color6/90 text-white px-4 py-1 text-sm"
              >
                Apply Now
              </Button>
            </div>
                  ...
                  return (
                    <Card
                      ...
                      className={`flex flex-col hover:shadow-md transition-shadow ${
                        isSelected ? "ring-2 ring-ngo-color6" : ""
                      }`}
                    >
                      {course.imageUrl && (
                        <img
