...
const useNavigation = () => {
  ...
  const navigation: NavigationItem[] = [
    ...
    },
    {
      label: 'Our Projects',
      items: [
        { label: 'IT Skills Training', href: '/our-projects/it-skills-training' },
        { label: 'Cluster Education', href: '/our-projects/cluster-education' },
        { label: 'Teachers Training', href: '/our-projects/teachers-training' },
        { label: 'Slum Children Education', href: '/our-projects/slum-children' },
        { label: 'Out of School Children Education', href: '/our-projects/out-of-school' },
        { label: 'Girls Education', href: '/our-projects/girls-education' },
        { label: 'Pedagogy Training', href: '/our-projects/pedagogy-training' },
        { label: 'Madarsa Education', href: '/our-projects/madarsa-education' },
        { label: 'Social and Financial Education', href: '/our-projects/social-financial' },
        { label: 'Adult Education', href: '/our-projects/adult-education' },
        { label: 'Public(Government) Schools Education', href: '/our-projects/public-schools' },
      ],
    },
